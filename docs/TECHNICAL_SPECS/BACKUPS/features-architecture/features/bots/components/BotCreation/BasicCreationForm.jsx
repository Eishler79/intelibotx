...
const BasicCreationForm = ({
  ...
  defaultValues = { symbol: 'BTCUSDT', market_type: 'SPOT', leverage: 1, stake: 100, take_profit: 2.5, stop_loss: 1.5, maxLeverage: 125 }
}) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <MarketTypeSelector
        ...
        maxLeverageDefault={defaultValues.maxLeverage}
      />
...
export default BasicCreationForm;